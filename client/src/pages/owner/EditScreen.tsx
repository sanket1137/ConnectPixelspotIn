  ...
  useEffect(() => {
    if (screen) {
      form.reset({
        ...
        customOperatingHours: screen.customOperatingHours || "",
        ...
        avgDwellTime: screen.avgDwellTime || 0,
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit, handleFormError)} className="space-y-6">
          ...
          <div className="flex gap-4 justify-end">
            ...
            <Button type="submit" disabled={updateScreenMutation.isPending} data-testid="button-submit">
